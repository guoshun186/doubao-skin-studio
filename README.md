...
本项目架构参考了 [workbuddy-skin-studio](https://github.com/cdredfox/workbuddy-skin-studio)（MIT 协议）的 CDP 注入思路，针对豆包工作的 DOM 结构、CSS 变量体系和非标准 Electron 壳进行了完全重写。
